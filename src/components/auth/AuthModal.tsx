...
const AuthModal = ({ isOpen, onClose, mode, onModeChange }: AuthModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gray-900 rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-800">
        <div className="p-6">
          <button
            onClick={onClose}
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400">
              {mode === 'login' 
                ? 'Sign in to access your creations' 
                : 'Join DreamForge AI to save your art'
              }
            </p>
          </div>
